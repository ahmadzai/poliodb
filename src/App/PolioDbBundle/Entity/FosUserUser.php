...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \App\PolioDbBundle\Entity\FosUserGroup $group
     *
     * @return FosUserUser
     */
    public function addGroup(\App\PolioDbBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \App\PolioDbBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\App\PolioDbBundle\Entity\FosUserGroup $group)
    {
