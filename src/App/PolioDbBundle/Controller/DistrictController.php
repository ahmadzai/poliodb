...
class DistrictController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $districts = $em->getRepository('AppPolioDbBundle:District')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('App\PolioDbBundle\Form\DistrictType', $district);
    ...
    {
        $deleteForm = $this->createDeleteForm($district);
        $editForm = $this->createForm('App\PolioDbBundle\Form\DistrictType', $district);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('district_edit', array('id' => $district->getDistrictCode()));
        }
    ...
    private function createDeleteForm(District $district)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('district_delete', array('id' => $district->getDistrictCode())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
